    ...
    return (
      ...
      <div className='block-highlight  h-3 w-full left-0 top-0 bg-emeraldGreen transition-all duration-500 ease-in-out'></div>
        ...
        <motion.div
            ...
            >
          <div className=""><Link href="/">Billy Arnold</Link></div>
          </motion.div>
          <motion.div
              initial={{ y: -100 }}
              animate={{ y: 0 }}
            ...
            >
          <div className="text-right"><Link href="/work">Work</Link> {`//`} <Link href="/about">About</Link> {`//`} <Link href="/contact">Contact</Link></div>
          </motion.div>
        </div>
