...
const Contact = (props) => {
    const classes = "flex flex-col relative justify-center w-full px-5 md:px-20 pb-20 font-semibold text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl min-h-[40vh] md:min-h-[50vh] " + props.className;
    ...
    return (
      ...
      >
          ...
          <div  className='overflow-hidden cursor-pointer' onClick={ () => {window.open("mailto:hello@billyarnold.co.uk")}}>
